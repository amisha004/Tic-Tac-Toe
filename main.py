...
root=Tk()
root.title("Tic Tac Toe By: Amisha")
#add Buttons
...
def ButtonClick(id):
    ...
    if( bu1['text']=='X' and bu2['text']=='X' and bu3['text']=='X' or
        ...
        bu3['text']=='O' and bu5['text']=='O' and bu7['text']=='O'):
            disableButton()
            c=1
            tkinter.messagebox.showinfo("Tic Tac Toe By: Amisha","Winner is player 2\n\n Player 1 Well tried!")
    elif b==9:
            disableButton()
            c=1
            tkinter.messagebox.showinfo("Tic Tac Toe By: Amisha","Ooops! Match is Draw.")
